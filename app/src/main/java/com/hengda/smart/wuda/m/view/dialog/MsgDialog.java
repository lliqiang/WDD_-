...
public class MsgDialog extends Dialog {
     ...
     * @return
     */
    public MsgDialog message(CharSequence msg) {
        mTxt.setText(msg);
        mTxt.setVisibility(View.VISIBLE);
        return this;
    }
    public MsgDialog speed(CharSequence msg){
     ...
     * @return
     */
    public MsgDialog message(int resId) {
     ...
     * @return
     */
    public MsgDialog dialogColor(int color) {
     ...
     * @return
     */
    public MsgDialog dialogColor(String colorString) {
     ...
     * @return
     */
    public MsgDialog frameAnim(int resId) {
     ...
     * @return
     */
    public MsgDialog tweenAnim(int drawable, int anim) {
     ...
     * @return
     */
    public MsgDialog cancelable(boolean cancelable) {
     ...
     * @return
     */
    public MsgDialog outsideCancelable(boolean outsideCancelable) {
     ...
     * @return
     */
    public MsgDialog setTypeface(Typeface typeface) {
